...
public class Office2HTML {
    ...
    private static final Log LOG = LogFactory.getLog(Office2HTML.class);
    ...
    public static File openOfficeToPDF(String inputFilePath) {
        return Office2HTML(inputFilePath);
    }
    ...
    public static void main(String[] args) {
        ...
        filenames[1] = "D:\\2.xlsx";
        filenames[0] = "D:\\4.pptx";
        filenames[2] = "D:\\3.accdb"; // 乱码
        filenames[3] = "D:\\2.rtf"; // ok
        filenames[4] = "D:\\1.pub"; // error
       // for (int i = 0; i < 1; i++) {
        Office2HTML.openOfficeToPDF(filenames[0]);
       // }
    }
